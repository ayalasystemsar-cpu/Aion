...
# A. ROL: MONITOREO (ESTÉTICA FIEL A LA IMAGEN + ICONO EN PESTAÑA + CIERRE)
if st.session_state.rol_sel == "MONITOREO":
    ...
    with t_radar:
        ...
        # CSS: Titileo de opacidad simple
        ...
        for _, r in df_objetivos.iterrows():
            try:
                ...
                folium.CircleMarker(
                    ...
                    radius=7, 
                    color=color_borde,
                    fill=True if es_sos else False,
