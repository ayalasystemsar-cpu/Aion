...
with st.sidebar:
    ...
    with st.expander("👤 SUPERVISORES"):
        ...
        user_sup = st.text_input("USUARIO RECURSO (APELLIDO)")
        pass_sup = st.text_input("CONTRASEÑA CRÍTICA", type="password")
...
# F. ROL: ADMINISTRADOR
    ...
    st.markdown('<div class="estacion-titulo">⚙️ NÚCLEO MAESTRO: AION-YAROKU</div>', unsafe_allow_html=True)
