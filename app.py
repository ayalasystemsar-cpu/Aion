...
if st.session_state.rol_sel == "MONITOREO":
    ...
    alertas_activas = df_emergencias[df_emergencias['ESTADO'].astype(str).str.upper() == 'PENDIENTE'] if not df_emergencias.empty and 'ESTADO' in df_emergencias.columns else pd.DataFrame()
...
# C. ROL: JEFE DE OPERACIONES
    ...
    # Definición segura de la variable antes de usarla
...
# D. ROL: SUPERVISOR
    ...
    if not st.session_state.sup_autenticado:
        ...
        df_f = df_objetivos[df_objetivos['SUPERVISOR'] == st.session_state.user_sel.strip().upper()].dropna(subset=['LATITUD', 'LONGITUD'])
...
# E. ROL: GERENCIA
    ...
    # Definición segura de la variable
