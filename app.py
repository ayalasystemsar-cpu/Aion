...
st.set_page_config(
    page_title="AION-YAROKU | COMMAND",
    page_icon="🛡️",
    layout="wide",
...
if "usuario_logueado" not in st.session_state:
  st.session_state.usuario_logueado = (
      query_params.get("logueado", "false") == "true"
  )
...
if "sup_autenticado" not in st.session_state:
  st.session_state.sup_autenticado = (
      query_params.get("sup_auth", "false") == "true"
  )

if "admin_autenticado" not in st.session_state:
  st.session_state.admin_autenticado = (
      query_params.get("admin_auth", "false") == "true"
  )
...
def actualizar_celda(pestana, fila, columna, valor):
  try:
    gc = conectar_google()
    if gc:
      nombre_hoja_real = obtener_mapeo_solapas().get(
          pestana.upper().strip(), pestana
      )
...
def cargar_datos_comisarias():
  ...
  if (
      not df_nube.empty
      and "COMISARIA" in df_nube.columns
      and len(df_nube) > 1
  ):
    df_nube["LATITUD"] = pd.to_numeric(
        df_nube["LATITUD"].astype(str).str.replace(",", "."), errors="coerce"
    )
    df_nube["LONGITUD"] = pd.to_numeric(
        df_nube["LONGITUD"].astype(str).str.replace(",", "."), errors="coerce"
    )
    return df_nube

  data = {
      "COMISARIA": [
          "COMISARÍA VECINAL 1A",
          "COMISARÍA VECINAL 1B",
          "COMISARÍA VECINAL 1C",
          "COMISARÍA VECINAL 2A",
          "COMISARÍA VECINAL 2B",
          "COMISARÍA VECINAL 3A",
          "COMISARÍA VECINAL 3B",
          "COMISARÍA VECINAL 4A",
          "COMISARÍA VECINAL 4B",
          "COMISARÍA VECINAL 4C",
          "COMISARÍA VECINAL 5A",
          "COMISARÍA VECINAL 5B",
          "COMISARÍA VECINAL 6A",
          "COMISARÍA VECINAL 6B",
          "COMISARÍA VECINAL 7A",
          "COMISARÍA VECINAL 7B",
          "COMISARÍA VECINAL 8A",
          "COMISARÍA VECINAL 8B",
          "COMISARÍA VECINAL 8C",
          "COMISARÍA VECINAL 9A",
          "COMISARÍA VECINAL 9B",
          "COMISARÍA VECINAL 9C",
          "COMISARÍA VECINAL 10A",
          "COMISARÍA VECINAL 10B",
          "COMISARÍA VECINAL 10C",
          "COMISARÍA VECINAL 11A",
          "COMISARÍA VECINAL 11B",
          "COMISARÍA VECINAL 12A",
          "COMISARÍA VECINAL 12B",
          "COMISARÍA VECINAL 12C",
          "COMISARÍA VECINAL 13A",
          "COMISARÍA VECINAL 13B",
          "COMISARÍA VECINAL 13C",
          "COMISARÍA VECINAL 14A",
          "COMISARÍA VECINAL 14B",
          "COMISARÍA VECINAL 14C",
          "COMISARÍA VECINAL 15A",
          "COMISARÍA VECINAL 15B",
          "COMISARÍA VECINAL 15C",
          "COMISARÍA SAN MARTÍN 1RA",
          "COMISARÍA AVELLANEDA 1RA",
          "COMISARÍA CAMPANA 1RA",
          "COMISARÍA SAN FERNANDO 1RA",
          "COMISARÍA TIGRE 1RA",
          "COMISARÍA PILAR 6TA",
          "COMISARÍA ESCOBAR 3RA",
          "COMISARÍA VICENTE LÓPEZ 2DA",
          "COMISARÍA SAN ISIDRO 1RA",
          "COMISARÍA LANÚS 1RA",
          "COMISARÍA LOMAS DE ZAMORA 1RA",
          "COMISARÍA MORÓN 1RA",
          "COMISARÍA LA MATANZA 1RA",
          "COMISARÍA TRES DE FEBRERO 1RA",
          "COMISARÍA QUILMES 1RA",
          "COMISARÍA VARELA 1RA",
          "COMISARÍA BERAZATEGUI 1RA",
          "COMISARÍA TIGRE 2DA (PACHECO)",
          "COMISARÍA ESCOBAR 1RA (BELÉN)",
          "COMISARÍA PILAR 1RA",
          "COMISARÍA ZÁRATE 1RA",
          "COMISARÍA CAMPANA 2DA",
          "COMISARÍA EXALTACIÓN DE LA CRUZ (CARDALES)",
          "COMISARÍA LUJÁN 1RA",
          "COMISARÍA MERCEDES 1RA",
          "COMISARÍA SAN ANDRÉS DE GILES",
          "COMISARÍA GENERAL SAN MARTÍN 2DA",
          "COMISARÍA VICENTE LÓPEZ 1RA",
          "COMISARÍA SAN ISIDRO 4TA (MARTÍNEZ)",
          "COMISARÍA SAN FERNANDO 2DA (VIRREYES)",
          "COMISARÍA TIGRE 3RA (DON TORCUATO)",
          "COMISARÍA MALVINAS ARGENTINAS 1RA",
          "COMISARÍA J. C. PAZ 1RA",
          "COMISARÍA SAN MIGUEL 1RA",
          "COMISARÍA MORENO 1RA",
          "COMISARÍA MERLO 1RA",
      ],
      "DIRECCION": [
          "Suipacha 1156",
          "Uruguay 350",
          "Tacuarí 770",
          "General Las Heras 2650",
          "Paraguay 1122",
          "Lavalle 2625",
          "San Juan 1767",
          "Zavaleta 425",
          "Av. Regimiento de Patricios 1150",
          "Benito Juárez 1445",
          "Maza 1250",
          "Av. Independencia 2250",
          "Av. La Plata 550",
          "Rivadavia 4701",
          "Piedras 1450",
          "Av. Directorio 1500",
          "Dellepiane 6900",
          "Av. General Paz 14500",
          "Av. Cruz 4500",
          "Av. Juan B. Alberdi 6752",
          "Coronel Cárdenas 2850",
          "Toneleroro 6400",
          "Segurola 1550",
          "Av. Gaona 3850",
          "Alejandro Magariños Cervantes 4525",
          "Av. Nazca 4550",
          "Cuenca 3250",
          "Miller 2750",
          "Arias 4450",
          "Manuela Pedraza 2340",
          "Av. Cabildo 2300",
          "Amenábar 2320",
          "Av. Cramer 3250",
          "Cnel. Díaz 2250",
          "Av. Coronel Díaz 2550",
          "Av. Santa Fe 3200",
          "Guzmán 346",
          "Av. Forest 1450",
          "Av. Triunvirato 4550",
...
def verificar_e_insertar_comisaria_automatica(
    com_n, com_d, com_l, com_t, lat, lon
):
  try:
    gc = conectar_google()
    if gc:
      ...
      try:
        ...
        hoja_comis = sh.add_worksheet(
            title="COMISARIAS", rows="100", cols="10"
        )
      ...
      for fila_c in registros_existentes[1:]:
        if (
            len(fila_c) > 0
            and str(fila_c[0]).strip().upper() == str(com_n).strip().upper()
        ):
          encontrada = True
          break
...
def registrar_objetivo_con_comisaria_automatica(
  ...
  try:
    ...
    for _, com in df_comis_filtrada.iterrows():
      lon1, lat1, lon2, lat2 = map(
          math.radians, [lon_f, lat_f, com["LONGITUD"], com["LATITUD"]]
      )
      dlon = lon2 - lon1
      dlat = lat2 - lat1
      a = (
  ...
  verificar_e_insertar_comisaria_automatica(
      com_n, com_d, com_l, com_t, com_lat_calc, com_lon_calc
  )
  return exito
...
def obtener_lista_supervisores_dinamica():
  ...
  if not df_u.empty:
    ...
    if col_r in df_u.columns and "ESTADO" in df_u.columns:
      sups_extra = df_u[
          (df_u[col_r].astype(str).str.strip().str.upper() == "SUPERVISOR")
          & (df_u["ESTADO"].astype(str).str.strip().str.upper() == "APROBADO")
      ][col_u].tolist()
      for s in sups_extra:
    ...
    if gc:
      ...
      for nombre in nombres_posibles:
        try:
          ...
          continue
      if hoja is None:
        hoja = sh.add_worksheet(
            title="REGISTRO QR SUPERVISORES", rows="100", cols="10"
        )
        hoja.append_row(
...
def generar_pdf_reporte(titulo_reporte, df_datos):
  ...
  elementos.append(
      Paragraph(
          "<b>AION-YAROKU | REPORTE TÁCTICO OFICIAL</b>", estilo_titulo
      )
  )
  elementos.append(
      Paragraph(
          f"<b>{titulo_reporte}</b><br/>Fecha de Emisión:"
          f" {obtener_hora_argentina()}",
          estilo_sub,
      )
  )
  ...
  if not df_datos.empty:
    ...
    for _, row in df_datos.iterrows():
      datos_tabla.append(
          [str(row[c]) if pd.notna(row[c]) else "" for c in columnas]
      )
...
def renderizar_mensajeria_global(rol_contexto):
  ...
  with st.form(key=f"form_msg_{rol_contexto}", clear_on_submit=True):
    if st.session_state.asunto_respuesta:
      ...
      asunto_input = st.text_input(
          "ASUNTO:", value=st.session_state.asunto_respuesta, disabled=True
      )
    else:
    ...
    with col_b:
      destinatarios_posibles = [
          ...
          "SUPERVISORES",
          "VIGILADOR",
      ] + obtener_lista_supervisores_dinamica()
    ...
    if st.form_submit_button("TRANSMITIR A LA RED"):
      if txt_msg.strip():
        escribir_registro_nube("MENSAJERIA", [
            ...
            destinatario,
            (asunto_input or "GENERAL").upper(),
            txt_msg.upper(),
            "PENDIENTE",
            gravedad,
        ])
        st.session_state.mensaje_enviado = (
            "RESPUESTA" if st.session_state.asunto_respuesta else "MENSAJE"
        )
        st.session_state.asunto_respuesta = None
      ...
      for asunto, grupo in df_msg.groupby("ASUNTO"):
        with st.expander(f"💬 Hilo: {asunto}"):
          for _, msg in grupo.iterrows():
            st.markdown(
                f"**{msg.get('REMITENTE', 'ANÓNIMO')}:**"
                f" {msg.get('MENSAJE', '')}"
            )
          if st.button(
              f"Responder a este hilo", key=f"btn_{asunto}_{rol_contexto}"
          ):
...
def enviar_alerta_automatica(
    emisor, objetivo, nombre_persona, supervisor_asignado
):
  ...
  for dest in destinatarios:
    if dest and dest != "MONITOREO" and dest != "N/A":
      escribir_registro_nube(
          "MENSAJERIA", [fecha, emisor, dest, mensaje, "PENDIENTE"]
      )
...
def limpiar_matriz_nube(nombre_hoja):
  try:
    ...
    if gc:
      nombre_hoja_real = obtener_mapeo_solapas().get(
          nombre_hoja.upper().strip(), nombre_hoja
      )
    ...
    for mat in matrices:
      ...
      if not df.empty:
        ...
        try:
          ...
          hoja_hist = gc.open_by_key(ID_MAESTRO_DB).add_worksheet(
              title=nombre_historico, rows="100", cols="20"
          )
        hoja_hist.clear()
...
def mostrar_landing():
  ...
  st.markdown(
      '<div class="contenedor-logo-central"><img'
      ' src="https://raw.githubusercontent.com/ayalasystemsar-cpu/Aion/main/assets/LOGO%20-%20AION-YAROKU.jpeg"'
      ' class="logo-phoenix"></div>',
      unsafe_allow_html=True,
  )
  st.markdown(
      '<div class="estacion-titulo">AION-YAROKU | COMMAND</div>',
      unsafe_allow_html=True,
  )
  ...
  with st.form("form_acceso_real"):
    ...
    if st.form_submit_button(btn_texto):
      ...
      if (
          modo == "Iniciar Sesión"
          and user_limpio == "ADMIN"
          and pass_limpio == "aion2026"
      ):
        ...
        st.rerun()
          ...
          modo == "Iniciar Sesión"
          and rol_usuario == "SUPERVISOR"
          and (
              user_limpio.startswith("SUPERVISOR")
              or user_limpio
              in [
                  "AYALA BRIAN",
                  "AYALA",
        ...
        usuario_final = (
            "AYALA BRIAN"
            if user_limpio in ["AYALA BRIAN", "AYALA"]
            else user_limpio
        )
        st.session_state.usuario_logueado = True
        ...
        st.rerun()
          ...
          modo == "Iniciar Sesión"
          and rol_usuario == "MONITOREO"
          and (
              user_limpio in ["MONITOREO", "OPERADOR", "OPERADOR CENTRAL"]
              or pass_limpio == "1234"
          )
      ):
        st.session_state.usuario_logueado = True
        st.session_state.user_sel = (
            "OPERADOR CENTRAL" if user_limpio == "MONITOREO" else user_limpio
        )
        ...
        st.rerun()
          ...
          modo == "Iniciar Sesión"
          and rol_usuario == "JEFE DE OPERACIONES"
          and (
              user_limpio in ["JEFE", "JEFE DE OPERACIONES"]
              or pass_limpio == "1234"
          )
      ):
        st.session_state.usuario_logueado = True
        ...
        st.rerun()
          ...
          modo == "Iniciar Sesión"
          and rol_usuario == "GERENCIA"
          and (
              user_limpio in ["GERENCIA", "DIRECTOR", "DIRECCIÓN GENERAL"]
              or pass_limpio == "1234"
          )
      ):
        st.session_state.usuario_logueado = True
        ...
        st.rerun()
          ...
          modo == "Iniciar Sesión"
          and rol_usuario == "VIGILADOR"
          and (
              user_limpio in ["VIGILADOR", "AGENTE", "CUSTODIO"]
              or pass_limpio == "1234"
          )
      ):
        st.session_state.usuario_logueado = True
        st.session_state.user_sel = (
            "VIGILADOR EN PUESTO" if user_limpio == "VIGILADOR" else user_limpio
        )
        ...
        if (
            ...
            and "USUARIO" in df_usuarios.columns
            and "CONTRASEÑA" in df_usuarios.columns
        ):
        ...
        if not usuario_ok.empty:
          estado = str(
              usuario_ok.iloc[0].get("ESTADO", "PENDIENTE")
          ).strip().upper()
          if estado == "APROBADO":
            rol_encontrado = (
                str(usuario_ok.iloc[0]["ROL"]).strip().upper()
            )
            st.session_state.usuario_logueado = True
            ...
            st.warning(
                "⚠️ Tu cuenta existe pero está PENDIENTE de aprobación por el"
                " Administrador."
            )
        else:
        ...
        if user.strip() and password.strip():
          exito_reg = escribir_registro_nube(
              "USUARIOS",
              [user.strip().upper(), password.strip(), rol_usuario, "PENDIENTE"],
          )
          if exito_reg:
            st.success(
                "✅ Solicitud de registro enviada con éxito. Inicie sesión una"
                " vez que el Administrador apruebe su cuenta."
            )
          else:
...
if st.session_state.rol_sel == "ADMINISTRADOR" or st.session_state.get(
    "admin_autenticado", False
):
  with st.sidebar:
    st.markdown(
        '<div class="contenedor-logo-sidebar"><img'
        ' src="https://raw.githubusercontent.com/ayalasystemsar-cpu/Aion/main/assets/LOGO%20-%20AION-YAROKU.jpeg"'
        ' style="width:180px; border:1px solid #00e5ff;'
    ...
    if "SUPERVISOR" in vista_admin_sel or st.session_state.rol_sel == "SUPERVISOR":
      ...
      nom_sup_elegido = st.selectbox(
          "ELEGIR RESPONSABLE:",
          LISTA_SUPS_TACTICOS,
          key="selector_directo_supervisor_admin",
      )
...
st.markdown(
    f'<div class="estacion-titulo">{titulos.get(st.session_state.rol_sel, "SISTEMA TÁCTICO DE COMANDO")}</div>',
    unsafe_allow_html=True,
)
...
if st.session_state.rol_sel == "MONITOREO":
  ...
  if df_emergencias.empty:
    df_emergencias = pd.DataFrame(
        columns=["FECHA", "USUARIO", "TIPO", "ESTADO", "OBJETIVO", "SUPERVISOR"]
    )
  else:
  ...
  if not df_objetivos.empty:
    ...
    if "LATITUD" in df_objetivos.columns and "LONGITUD" in df_objetivos.columns:
      df_mapa_monitoreo = df_objetivos.dropna(
          subset=["LATITUD", "LONGITUD"]
      ).copy()

  lista_objetivos_en_panico = []
  if (
      not df_emergencias.empty
      and "ESTADO" in df_emergencias.columns
      and "TIPO" in df_emergencias.columns
  ):
  ...
  label_msg = (
      f"💬 MENSAJERÍA GLOBAL ({total_nuevos})"
      if total_nuevos > 0
      else "💬 MENSAJERÍA GLOBAL"
  )

  t_radar, t_mensajeria, t_nov = st.tabs([
      "🚨 RADAR S.O.S",
      label_msg,
      "Auditoría y registro de monitoreo por supervisor",
  ])
  ...
  with t_radar:
    ...
    if not df_alertas_radar.empty:
      df_alertas_radar.columns = [
          str(c).strip().upper() for c in df_alertas_radar.columns
      ]
      panicos_pendientes_globales = (
          df_alertas_radar[
              (df_alertas_radar["TIPO"].astype(str).str.upper() == "PÁNICO")
              & (df_alertas_radar["ESTADO"].astype(str).str.upper() == "PENDIENTE")
          ]
          if "TIPO" in df_alertas_radar.columns
          and "ESTADO" in df_alertas_radar.columns
          else pd.DataFrame()
      )
      ...
      if not panicos_pendientes_globales.empty:
        ...
        for idx_gp, row_gp in panicos_pendientes_globales.iterrows():
          ...
          col_p1.markdown(
              f"**Usuario:** {row_gp.get('USUARIO','')} | **Objetivo:**"
              f" {row_gp.get('OBJETIVO','')} | **Fecha:**"
              f" {row_gp.get('FECHA','')}"
          )

          key_btn_radar = (
              f"fin_pan_radar_{idx_gp}_{row_gp.get('USUARIO','')}_{row_gp.get('OBJETIVO','')}_{row_gp.get('FECHA','')}"
              .replace(" ", "_")
          )
          if col_p2.button(f"✅ Finalizar Pánico", key=key_btn_radar):
            gc_rg = conectar_google()
            if gc_rg:
              hoja_alt_rg = gc_rg.open_by_key(ID_MAESTRO_DB).worksheet(
                  "ALERTAS"
              )
              ...
              for i_rg, fila_rg in enumerate(todas_a_rg[1:], start=2):
                if (
                    len(fila_rg) > 5
                    and fila_rg[1].strip().upper()
                    == str(row_gp.get("USUARIO", "")).strip().upper()
                    and fila_rg[4].strip().upper()
                    == str(row_gp.get("OBJETIVO", "")).strip().upper()
                    and fila_rg[3].strip().upper() == "PENDIENTE"
                ):
                  hoja_alt_rg.update_acell(f"D{i_rg}", "FINALIZADO")
                  st.success(
                      "✅ Pánico finalizado correctamente desde el Radar."
                  )
                  st.cache_data.clear()
                  st.rerun()
        st.markdown("---")
    ...
    sup_filtro_mono = col_filt1.selectbox(
        "🔍 FILTRAR POR SUPERVISOR:",
        lista_sups_monitoreo,
        key="filtro_sup_monitoreo",
    )
    ...
    if sup_filtro_mono != "TODOS LOS SUPERVISORES":
      if "SUPERVISOR" in df_mapa_filtrado_sup.columns:
        df_mapa_filtrado_sup = df_mapa_filtrado_sup[
            df_mapa_filtrado_sup["SUPERVISOR"].astype(str).str.strip().str.upper()
            == sup_filtro_mono
        ]

    if (
        sup_filtro_mono != "TODOS LOS SUPERVISORES"
        and not df_mapa_filtrado_sup.empty
    ):
      ...
      if not df_jornadas_mon.empty:
        df_jornadas_mon.columns = [
            str(c).strip().upper() for c in df_jornadas_mon.columns
        ]
        fecha_hoy_str = datetime.now(
      ...
      porcentaje_progreso = (
          int((visitados_sup_count / total_objs_sup) * 100)
          if total_objs_sup > 0
          else 0
      )
      ...
      col_filt2.info(
          "Seleccione un supervisor específico para ver su métrica de cobertura."
      )
    ...
    with col_sel1:
      opciones_busqueda = (
          ["MOSTRAR TODO"] + list(df_mapa_filtrado_sup["OBJETIVO"].unique())
          if not df_mapa_filtrado_sup.empty
          else ["MOSTRAR TODO"]
      )
      try:
        idx_defecto = opciones_busqueda.index(
            st.session_state["filtro_radar_valor"]
        )
      except:
        idx_defecto = 0
    ...
    if obj_seleccionado != "MOSTRAR TODO" and not df_mapa_filtrado_sup.empty:
      datos_obj = df_mapa_filtrado_sup[
          df_mapa_filtrado_sup["OBJETIVO"] == obj_seleccionado
      ].iloc[0]
      ...
      if localidad_obj_val and "LOCALIDAD" in df_comisarias.columns:
        df_sub_c = df_comisarias[
            df_comisarias["LOCALIDAD"].astype(str).str.strip().str.upper()
            == localidad_obj_val
        ]
      ...
      for _, com in df_comis_filtro_mono.iterrows():
        lon1, lat1, lon2, lat2 = map(
            math.radians,
            [lon_obj, lat_obj, com["LONGITUD"], com["LATITUD"]],
        )
        dlon = lon2 - lon1
        dlat = lat2 - lat1
        a = (
      ...
      with col_sel2:
        ...
        if comisaria_cercana_name:
          ...
          st.markdown(
              f'<a href="{url_gmaps_monitoreo}" target="_blank"'
              ' class="btn-google-maps" style="font-size:11px; padding:6px 12px;'
              ' margin-top:5px;">🗺️ ASISTENTE GPS COMPARTIDO</a>',
              unsafe_allow_html=True,
          )
    else:
      with col_sel2:
        st.info(
            "Seleccione un objetivo específico para calcular la comisaría más"
            " cercana."
        )
    ...
    if not df_mapa_filtrado_sup.empty:
      if obj_seleccionado != "MOSTRAR TODO":
        ...
        centro_mapa = [
            df_mapa_filtrado_sup["LATITUD"].mean(),
            df_mapa_filtrado_sup["LONGITUD"].mean(),
        ]
        zoom_inicial = 11
      ...
      for _, r in df_mapa_filtrado_sup.iterrows():
        ...
        if es_panico:
          alerta_activa = (
              ...
              if "OBJETIVO" in df_emergencias.columns
              else pd.DataFrame()
          )
        ...
        if es_panico or es_el_seleccionado:
          folium.Marker(
              ...
              icon=folium.DivIcon(
                  ...
                  icon_anchor=(15, 15),
                  html=(
                      '<div style="background-color: #FF0000; width: 16px;'
                      " height: 16px; border-radius: 50%; border: 2px solid"
                      " white; animation: pulse 1s infinite alternate;\"></div>"
                  ),
              ),
          ).add_to(m_mon)
        else:
      ...
      for _, c in df_com.iterrows():
        ...
        if es_la_mas_cercana and obj_seleccionado != "MOSTRAR TODO":
          ...
          coordenadas_ruta = obtener_ruta_calles_osrm(
              lat_obj, lon_obj, com_lat, com_lon
          )
          ...
          folium.PolyLine(
              locations=coordenadas_ruta, color="#000000", weight=5, opacity=0.4
          ).add_to(m_mon)
          folium.PolyLine(
              locations=coordenadas_ruta, color="#39FF14", weight=4, opacity=0.8
          ).add_to(m_mon)
        else:
          color_icono = "#0000FF"
          tamano_fuente = "20px"
        ...
        folium.Marker(
            ...
            icon=folium.DivIcon(
                html=(
                    f'<div style="font-size: {tamano_fuente}; color:'
                    f" {color_icono}; text-shadow: 0 0 10px"
                    f' {color_icono};"><i class="fa fa-shield"></i></div>'
                )
            ),
        ).add_to(m_mon)
      ...
      st_folium(
          ...
          height=500,
          key="mapa_monitoreo_radar_tactico",
      )
    st.markdown("</div>", unsafe_allow_html=True)
  ...
  with t_nov:
    ...
    if not df_qr_m_base.empty:
      df_qr_m_base.columns = [
          str(c).strip().upper() for c in df_qr_m_base.columns
      ]
      col_sup_qm = (
          "SUPERVISOR"
          if "SUPERVISOR" in df_qr_m_base.columns
          else df_qr_m_base.columns[3]
      )
      if col_sup_qm in df_qr_m_base.columns:
        for s in (
            df_qr_m_base[col_sup_qm]
            .dropna()
            .astype(str)
            .str.strip()
            .str.upper()
          ...
          if s and s != "NAN":
            sups_dinamicos_set.add(s)

    if not df_jor_m_base.empty:
      df_jor_m_base.columns = [
          str(c).strip().upper() for c in df_jor_m_base.columns
      ]
      col_sup_jm = (
          "SUPERVISOR"
          if "SUPERVISOR" in df_jor_m_base.columns
          else df_jor_m_base.columns[1]
      )
      if col_sup_jm in df_jor_m_base.columns:
        for s in (
            df_jor_m_base[col_sup_jm]
            .dropna()
            .astype(str)
            .str.strip()
            .str.upper()
    ...
    if not df_flota_m_base.empty:
      df_flota_m_base.columns = [
          str(c).strip().upper() for c in df_flota_m_base.columns
      ]
      col_sup_fm = (
          "SUPERVISOR"
          if "SUPERVISOR" in df_flota_m_base.columns
          else df_flota_m_base.columns[1]
      )
      if col_sup_fm in df_flota_m_base.columns:
        for s in (
            df_flota_m_base[col_sup_fm]
            .dropna()
            .astype(str)
            .str.strip()
            .str.upper()
    ...
    opciones_filtro_monitoreo = [
        "VER TODOS LOS SUPERVISORES"
    ] + sups_dinamicos_lista
    sup_elegido_monitoreo_tab = st.selectbox(
        "🔍 FILTRAR AUDITORÍA POR SUPERVISOR O VER TODOS:",
        opciones_filtro_monitoreo,
        key="filtro_auditoria_monitoreo_gral",
    )

    lista_sups_a_mostrar = (
        sups_dinamicos_lista
        if sup_elegido_monitoreo_tab == "VER TODOS LOS SUPERVISORES"
        else [sup_elegido_monitoreo_tab]
    )
      ...
      for idx_p, sup_seleccionado_mono in enumerate(lista_sups_a_mostrar):
        with pestanas_sups[idx_p]:
          ...
          if not df_qr_m_base.empty:
            ...
            df_sup_qrs_m = df_qr_m_base[
                df_qr_m_base[col_sup_qm].astype(str).str.strip().str.upper()
                == str(sup_seleccionado_mono).strip().upper()
            ]
          ...
          if not df_nov_m_base.empty:
            df_nov_m_base.columns = [
                str(c).strip().upper() for c in df_nov_m_base.columns
            ]
            objs_del_sup = [
                o.strip().upper()
                for o in df_objetivos[
                    df_objetivos["SUPERVISOR"]
                    .astype(str)
                    .str.strip()
                    .str.upper()
                    == str(sup_seleccionado_mono).strip().upper()
                ]["OBJETIVO"].tolist()
            ] if not df_objetivos.empty else []

            if len(objs_del_sup) > 0 and "OBJETIVO" in df_nov_m_base.columns:
              df_nov_m_base["OBJETIVO_CLEAN"] = (
                  df_nov_m_base["OBJETIVO"]
                  .astype(str)
                  .str.strip()
                  .str.upper()
              )
              ...
              for posible_col in [
                ...
                if posible_col in df_nov_m_base.columns:
                  ...
                  break
              if (
                  col_evento_real is None
                  and len(df_nov_m_base.columns) > 2
              ):
                col_evento_real = df_nov_m_base.columns[2]

              if col_evento_real:
                mask_fich = df_nov_m_base["OBJETIVO_CLEAN"].isin(
                    objs_del_sup
                ) & df_nov_m_base[col_evento_real].astype(str).str.strip().str.upper().str.contains(
                    "MARCACIÓN|FICHAJE|INGRESO|EGRESO", regex=True
                )
              ...
              if not df_fichajes_sup_filtrado.empty:
                st.dataframe(
                    df_fichajes_sup_filtrado.iloc[::-1],
                    use_container_width=True,
                    hide_index=True,
                )
              else:
                st.info(
                    "No hay fichajes de vigiladores registrados para los"
                    " objetivos de este supervisor."
                )
            else:
              st.info(
                  "Este supervisor no tiene objetivos asignados en la red."
              )
          else:
          ...
          if not df_vig_rel_m_base.empty:
            df_vig_rel_m_base.columns = [
                str(c).strip().upper() for c in df_vig_rel_m_base.columns
            ]
            objs_del_sup = (
                df_objetivos[
                    df_objetivos["SUPERVISOR"]
            ...
            if len(objs_del_sup) > 0:
              col_obj_v = (
                  "OBJETIVO"
                  if "OBJETIVO" in df_vig_rel_m_base.columns
                  else df_vig_rel_m_base.columns[2]
              )
              df_rel_sup_filtrado = df_vig_rel_m_base[
                  df_vig_rel_m_base[col_obj_v]
                  .astype(str)
                  .str.strip()
                  .str.upper()
                  .isin([o.upper() for o in objs_del_sup])
              ]

              if not df_rel_sup_filtrado.empty:
                st.dataframe(
                    df_rel_sup_filtrado.iloc[::-1],
                    use_container_width=True,
                    hide_index=True,
                )
              else:
                st.info(
                    "No hay relevos de vigiladores registrados para los"
                    " objetivos de este supervisor."
                )
            else:
          ...
          if not df_alt_m_base.empty:
            df_alt_m_base.columns = [
                str(c).strip().upper() for c in df_alt_m_base.columns
            ]
            df_panicos_op = (
                df_alt_m_base[
                    df_alt_m_base["TIPO"].astype(str).str.strip().str.upper()
                    == "PÁNICO"
                ].copy()
                if "TIPO" in df_alt_m_base.columns
                else pd.DataFrame()
            )

            if not df_panicos_op.empty:
              mask_solo_supervisor = (
                  df_panicos_op["USUARIO"]
                  .astype(str)
                  .str.strip()
                  .str.upper()
                  == str(sup_seleccionado_mono).strip().upper()
          ...
          if not df_alt_m_base.empty:
            ...
            if not df_panicos_op.empty:
              mask_obj_del_sup = df_panicos_op["OBJETIVO"].astype(
                  str
              ).str.strip().str.upper().isin([o.upper() for o in objs_del_sup])
              mask_no_es_supervisor = ~(
                  df_panicos_op["USUARIO"]
                  .astype(str)
                  .str.strip()
                  .str.upper()
              ...
              df_pan_vig_filtrado = df_panicos_op[
                  mask_obj_del_sup & mask_no_es_supervisor
              ]
            else:
            ...
            if not df_pan_vig_filtrado.empty:
              ...
              st.dataframe(
                  df_pan_vig_c_turno_m.iloc[::-1],
                  use_container_width=True,
                  hide_index=True,
              )
            else:
              st.info(
                  "No hay pánicos S.O.S de vigiladores registrados en los"
                  " objetivos de este supervisor."
              )
          else:
          ...
          if not df_alt_m_base.empty:
            ...
            mask_solo_sup_cnt = (
                df_panicos_op_total["USUARIO"]
                .astype(str)
                .str.strip()
                .str.upper()
                == str(sup_seleccionado_mono).strip().upper()
            ) if not df_panicos_op_total.empty else pd.Series([False])
            total_alertas_supervisor = (
                len(df_panicos_op_total[mask_solo_sup_cnt])
                if not df_panicos_op_total.empty
                else 0
            )
            ...
            mask_obj_sup_cnt = (
                df_panicos_op_total["OBJETIVO"]
                .astype(str)
                .str.strip()
                .str.upper()
                .isin([o.upper() for o in objs_del_sup_cnt])
            ) if not df_panicos_op_total.empty and "OBJETIVO" in df_panicos_op_total.columns else pd.Series([False])
            mask_no_sup_cnt = (
                ~mask_solo_sup_cnt
                if not df_panicos_op_total.empty
                else pd.Series([False])
            )
            total_alertas_vigilador = (
                len(df_panicos_op_total[mask_obj_sup_cnt & mask_no_sup_cnt])
                if not df_panicos_op_total.empty
                else 0
            )
            ...
            if (
                total_alertas_supervisor > 0
                or total_alertas_vigilador > 0
                or not df_alt_sup_filtrado.empty
            ):
              if total_alertas_supervisor > 0:
                st.markdown(
                    f"• TOTAL ALERTAS DE SUPERVISOR:"
                    f" **{total_alertas_supervisor}**"
                )
              if total_alertas_vigilador > 0:
                st.markdown(
                    f"• TOTAL ALERTAS DE VIGILADOR:"
                    f" **{total_alertas_vigilador}**"
                )
              ...
              st.info(
                  "No hay alertas operativas adicionales registradas para los"
                  " objetivos de este supervisor."
              )
          else:
  ...
  if st.session_state.sup_autenticado:
    ...
    with col_j1:
      if st.button("🚀 INICIO DE JORNADA", use_container_width=True):
        registrar_jornada_general(
            st.session_state.user_sel, obj_actual, "INICIO"
        )
    ...
    if obj_actual != "SIN OBJETIVO":
      ...
      st.warning(
          "⚠️ Selecciona tu objetivo en 'Visita QR' para activar el pánico"
          " correctamente."
      )
      ...
      if st.button("S.O.S\nPÁNICO", type="primary"):
        ...
        if not df_objetivos.empty:
          ...
          if not filtro_sup_obj.empty:
            lat_obj_s = float(
                str(filtro_sup_obj["LATITUD"].iloc[0]).replace(",", ".")
            )
            lon_obj_s = float(
                str(filtro_sup_obj["LONGITUD"].iloc[0]).replace(",", ".")
            )
            localidad_obj_s = (
                str(filtro_sup_obj.iloc[0].get("LOCALIDAD", ""))
                .strip()
                .upper()
            )
        ...
        for _, com in df_comis_filtro_s.iterrows():
          try:
            lon1, lat1, lon2, lat2 = map(
                math.radians,
                [lon_obj_s, lat_obj_s, com["LONGITUD"], com["LATITUD"]],
            )
            d = (
                6371
                * 2
    ...
    t_vis_qr, t_nuevo_obj, t_ruta_gmaps, t_car_tac, t_mensajeria_sup, t_pres_sup = (
        st.tabs([
            "Visita QR",
            "➕ CARGAR OBJETIVO",
            "📲 RUTA GOOGLE MAPS",
    ...
    with t_vis_qr:
      ...
      st.markdown(
          f"### 📊 ESTADO DE MIS OBJETIVOS ASIGNADOS ({fecha_hoy_str})"
      )
      ...
      if not df_objetivos_filtrados.empty:
        ...
        for obj_item in df_objetivos_filtrados["OBJETIVO"].unique():
          ...
          if not df_jornadas_act.empty:
            df_jornadas_act.columns = [
                str(c).strip().upper() for c in df_jornadas_act.columns
            ]
            ...
            df_j_obj = df_jornadas_act[
                ...
                & (
                    df_jornadas_act[col_obj]
                    .astype(str)
                    .str.strip()
                    .str.upper()
                    == obj_item.strip().upper()
                )
                & (
                    df_jornadas_act[col_fec_hora]
                    .astype(str)
                    .str.contains(fecha_hoy_str)
                )
            ]

            if not df_j_obj.empty:
              inicios = df_j_obj[
                  df_j_obj[col_acc].astype(str).str.strip().str.upper()
                  == "INICIO"
              ]
              fines = df_j_obj[
                  df_j_obj[col_acc].astype(str).str.strip().str.upper() == "FIN"
              ]
              ...
              if hora_ingreso_dt and hora_egreso_dt:
                if hora_egreso_dt >= hora_ingreso_dt:
                  ...
                  permanencia_txt = (
                      f"{horas}h {mins}m" if horas > 0 else f"{mins} min"
                  )
                else:
                  permanencia_txt = "---"
      ...
      if not df_objetivos_filtrados.empty:
        obj_select = st.selectbox(
            "Seleccione su Objetivo Asignado:",
            df_objetivos_filtrados["OBJETIVO"].unique(),
            key="obj_qr_tactico",
        )
        datos_sel = df_objetivos_filtrados[
            df_objetivos_filtrados["OBJETIVO"] == obj_select
        ].iloc[0]

        st.markdown("---")
        st.markdown(
            "### 📷 ESCANEO TÁCTICO DE PUESTO (VALIDACIÓN EN TIEMPO REAL)"
        )
        st.info("Alinee el código QR dentro del visor.")

        tipo_mov_qr = st.radio(
            "TIPO DE MOVIMIENTO QR:",
            ["INICIO (INGRESO)", "FIN (EGRESO)"],
            horizontal=True,
            key="radio_tipo_mov_qr",
        )
        ...
        if codigo_qr_leido is not None and str(codigo_qr_leido).strip() != "":
          ...
          if (
              st.session_state.get("ultimo_qr_procesado")
              != clave_registro_actual
          ):
            st.session_state.ultimo_qr_procesado = clave_registro_actual
            try:
              exito_registro = registrar_qr_supervisor(
                  st.session_state.user_sel, obj_select, accion_str
              )
              if exito_registro:
                try:
                  escribir_registro_nube("NOVEDADES GUARDIA", [
                      obtener_hora_argentina(),
                      obj_select,
                      f"SUPERVISIÓN QR VALIDADA ({accion_str})",
                      "---",
                      st.session_state.user_sel,
                      "---",
                      "PROCESADO",
                ...
                if accion_str == "INICIO":
                  st.session_state.ultimo_mensaje_qr = (
                      f"✅ ¡INGRESO (INICIO) REGISTRADO CORRECTAMENTE PARA EL"
                      f" OBJETIVO: {obj_select}!"
                  )
                else:
                  st.session_state.ultimo_mensaje_qr = (
                      f"🏁 ¡EGRESO (FIN) REGISTRADO CORRECTAMENTE PARA EL"
                      f" OBJETIVO: {obj_select}!"
                  )
                ...
                st.error(
                    "❌ Error al registrar en la nube. Intente nuevamente."
                )
            except Exception as e:
        ...
        with col_qr1:
          qr_data_string = (
              f"AION-YAROKU-OBJ:{obj_select}|ID:{datos_sel.get('ID', '0')}"
          )
          qr = qrcode.QRCode(
              version=1,
          ...
          st.image(
              buffered.getvalue(), width=160, caption=f"QR Oficial: {obj_select}"
          )
        ...
        with col_qr2:
          ...
          st.write(
              f"**Coordenadas:** {datos_sel.get('LATITUD', 0)},"
              f" {datos_sel.get('LONGITUD', 0)}"
          )
        ...
        with st.form(key="form_acta_flota", clear_on_submit=True):
          ...
          v_combustible = c_a.selectbox(
              "TIPO DE COMBUSTIBLE:",
              ["NAFTA SÚPER", "NAFTA PREMIUM", "GASOIL", "OTRO"],
          )
          v_monto_str = c_b.text_input("MONTO CARGADO ($):", value="0,00")
          v_vig = st.text_input(
              "SUPERVISOR RESPONSABLE:", value=st.session_state.user_sel
          ).upper()
          ...
          if st.form_submit_button("REGISTRAR ACTA DE FLOTA"):
            ...
            costo_km = (
                round(v_monto / km_recorridos, 2) if km_recorridos > 0 else 0.0
            )
            estado_auditoria = (
                "⚠️ REVISAR" if costo_km > 300 or costo_km == 0 else "✅ ACORDE"
            )
            ...
            st.success(
                f"✅ Acta registrada. Distancia recorrida: {km_rec_fmt} km |"
                f" Gasto: ${monto_fmt}"
            )
      else:
        st.warning(
            "⚠️ No se encontraron objetivos asignados a su usuario Supervisor."
        )
    ...
    with t_nuevo_obj:
      ...
      with tab_alta_sup:
        with st.form(key="form_crear_objetivo_supervisor", clear_on_submit=False):
          ...
          nuevo_nombre_obj = col_no1.text_input(
              "NOMBRE DEL OBJETIVO:", value="CARLOS PELLEGRINI"
          ).upper().strip()
          nueva_direccion = col_no2.text_input(
              "DIRECCIÓN:", value="1163"
          ).upper().strip()

          col_loc1, col_loc2 = st.columns(2)
          nueva_localidad = col_loc1.text_input(
              "LOCALIDAD:", value="CABA"
          ).upper().strip()
          nueva_lat = col_loc2.text_input(
              "LATITUD (Ej: -34.5985):", value="-34.5985"
          )

          col_lon1, col_lon2 = st.columns(2)
          nueva_lon = col_lon1.text_input(
              "LONGITUD (Ej: -58.3838):", value="-58.3838"
          )
          nuevos_responsables = col_lon2.text_input(
              "RESPONSABLES:", value="CENTRO"
          ).upper().strip()
          ...
          if st.form_submit_button("🚀 DAR DE ALTA OBJETIVO EN LA RED"):
            if nuevo_nombre_obj and nueva_lat and nueva_lon:
              ...
              if exito_alta:
                st.success(
                    f"✅ ¡Objetivo '{nuevo_nombre_obj}' y comisaría"
                    " jurisdiccional cargados con éxito en la red!"
                )
              else:
                st.error(
                    "❌ Error al registrar en la nube. Verifique la conexión con"
                    " Google Sheets."
                )
            else:
              st.warning(
                  "⚠️ Complete los campos obligatorios (Nombre, Latitud y"
                  " Longitud)."
              )
      ...
      with tab_baja_sup:
        if not df_objetivos_filtrados.empty:
          with st.form(key="form_baja_objetivo_supervisor", clear_on_submit=True):
            obj_a_baja = st.selectbox(
                "SELECCIONE OBJETIVO A DAR DE BAJA:",
                df_objetivos_filtrados["OBJETIVO"].unique(),
            )
            motivo_baja = st.text_input("MOTIVO DE LA BAJA:")
            if st.form_submit_button("🗑️ SOLICITAR BAJA DE OBJETIVO"):
              escribir_registro_nube("SOLICITUDES DE ACCESO", [
                  obtener_hora_argentina(),
                  st.session_state.user_sel,
                  "BAJA",
                  f"{obj_a_baja} - MOTIVO: {motivo_baja}",
                  "PENDIENTE",
              ])
              st.success(
                  f"✅ Petición de baja enviada para '{obj_a_baja}'."
              )
    ...
    with t_ruta_gmaps:
      ...
      if len(opciones_r) > 0:
        ...
        datos_r = df_objetivos_filtrados[
            df_objetivos_filtrados["OBJETIVO"] == obj_r
        ].iloc[0]
        lat, lon = datos_r["LATITUD"], datos_r["LONGITUD"]
        loc_r = str(datos_r.get("LOCALIDAD", "")).strip().upper()

        dist_min, com_name, com_lat, com_lon = (
            float("inf"),
            "Ninguna",
            0.0,
            0.0,
          ...
          d = (
              ...
              * math.asin(
                  math.sqrt(
                      ...
                      * math.cos(math.radians(com["LATITUD"]))
                      * math.sin(
                          (
                              math.radians(com["LONGITUD"])
                              - math.radians(lon)
                          )
                          / 2
                      )
        ...
        st.info(
            f"👮 **Comisaría Encontrada:** {com_name} ({dist_min:.2f} Km)"
        )
        st.link_button(
            "🗺️ ABRIR ASISTENTE GPS",
            f"https://www.google.com/maps/dir/?api=1&origin={com_lat},{com_lon}&destination={lat},{lon}&travelmode=driving",
            use_container_width=True,
        )
    ...
    with t_pres_sup:
      ...
      if not df_qr_sup_base.empty:
        df_qr_sup_base.columns = [
            str(c).strip().upper() for c in df_qr_sup_base.columns
        ]
        col_sup_q = (
            "SUPERVISOR"
            if "SUPERVISOR" in df_qr_sup_base.columns
            else df_qr_sup_base.columns[3]
        )
        df_qr_sup_propio = df_qr_sup_base[
            df_qr_sup_base[col_sup_q].astype(str).str.strip().str.upper()
            == sup_activo_normalizado
        ]
        if not df_qr_sup_propio.empty:
          st.dataframe(
              df_qr_sup_propio.iloc[::-1],
              use_container_width=True,
              hide_index=True,
          )
        else:
    ...
    st.warning(
        "⚠️ Autentíquese con sus credenciales de supervisor en la barra"
        " lateral."
    )
...
# =========================================================================
  ...
  st.markdown('<div class="panel-novedad">', unsafe_allow_html=True)
  opciones_globales_obj = (
      df_objetivos["OBJETIVO"].unique()
      if not df_objetivos.empty
      else ["ALFAVINIL"]
  )

  if (
      "obj_actual_vig" not in st.session_state
      or not st.session_state.obj_actual_vig
  ):
  ...
  if obj_detectado:
    ...
    with col_pv2:
      if st.button("S.O.S\nPÁNICO", type="primary"):
        nombre_real = st.session_state.get(
            "v_nombre_completo", st.session_state.user_sel
        ).upper()
        ...
        if not df_objetivos.empty:
          ...
          if not filtro.empty:
            ...
            lat_obj_vig = float(
                str(filtro["LATITUD"].iloc[0]).replace(",", ".")
            )
            lon_obj_vig = float(
                str(filtro["LONGITUD"].iloc[0]).replace(",", ".")
            )
            localidad_obj_v = (
                str(filtro.iloc[0].get("LOCALIDAD", "")).strip().upper()
            )
        ...
        for _, com in df_comis_filtro_v.iterrows():
          try:
            lon1, lat1, lon2, lat2 = map(
                math.radians,
                [lon_obj_vig, lat_obj_vig, com["LONGITUD"], com["LATITUD"]],
            )
            dlon = lon2 - lon1
            dlat = lat2 - lat1
            a = (
        ...
        escribir_registro_nube(
            "ALERTAS",
            [fecha, nombre_real, "PÁNICO", "PENDIENTE", obj_detectado, sup_asignado],
        )
        enviar_alerta_automatica(
            "SISTEMA_VIGILADOR", obj_detectado, nombre_real, sup_asignado
        )
    ...
    st.warning(
        "⚠️ Debes realizar el Fichaje o Relevo primero para activar el sistema"
        " de pánico."
    )

  st.markdown("---")

  tab_presentismo, tab_relevo, t_mensajeria = st.tabs(
  ...
  with tab_presentismo:
    ...
    with st.form(key="form_fichaje_vigilador", clear_on_submit=True):
      v_nombre_completo = st.text_input(
          "APELLIDO Y NOMBRE:",
          value=(
              "VIGILADOR DE PRUEBA"
              if st.session_state.user_sel != "VIGILADOR EN PUESTO"
              else ""
          ),
      ).strip()
      v_legajo = st.text_input(
          "LEGAJO:",
          value=(
              "12345"
              if st.session_state.user_sel != "VIGILADOR EN PUESTO"
      ...
      if st.form_submit_button("CONSIGNAR Y TRANSMITIR"):
        if v_nombre_completo and v_legajo:
          ...
          sup_responsable = (
              df_objetivos[df_objetivos["OBJETIVO"] == v_obj][
                  "SUPERVISOR"
              ].iloc[0]
              if not df_objetivos.empty
              else "N/A"
          ...
          st.success(
              f"🔒 {tipo_evento} REGISTRADA PARA {v_nombre_completo.upper()}"
          )
        else:
  ...
  with tab_relevo:
    ...
    with st.form(key="form_relevo_vigilador_directo", clear_on_submit=True):
      v_obj_relevo = st.selectbox(
          "OBJETIVO:", opciones_globales_obj, key="relevo_obj"
      )
      vig_saliente = st.text_input(
          "SALE (EGRESA):", value="AGENTE SALIENTE"
      ).upper().strip()
      vig_entrante = st.text_input(
          "ENTRA (INGRESA):", value="AGENTE ENTRANTE"
      ).upper().strip()
      v_dni_relevo = st.text_input(
          "DNI DE QUIEN INGRESA:", value="12345678"
      ).strip()

      if st.form_submit_button("SANCIONAR CAMBIO"):
        st.session_state.obj_actual_vig = v_obj_relevo
        sup_resp = (
            df_objetivos[df_objetivos["OBJETIVO"] == v_obj_relevo][
                "SUPERVISOR"
            ].iloc[0]
            if not df_objetivos.empty
            else "N/A"
        ...
        escribir_registro_nube("VIGILADORES", [
            fecha_hoy,
            hora_actual,
            v_obj_relevo,
            vig_saliente,
...
if st.session_state.rol_sel in ["JEFE DE OPERACIONES", "GERENCIA"]:
  ...
  with col1.container():
    ...
    def mostrar_sos():
      ...
      df_pan_vig_jefe = (
          ...
          if not df_alertas.empty and "TIPO" in df_alertas.columns
          else pd.DataFrame()
      )
  ...
  total_nuevos = (
      ...
      if not df_msg.empty and "ESTADO" in df_msg.columns
      else 0
  )
  ...
  st.markdown(
      f'<h2 style="color:#00E5FF; font-family:\'Orbitron\';'
      f' font-size:24px;">Comando: {st.session_state.rol_sel}</h2>',
      unsafe_allow_html=True,
  )

  t_mensajeria_jefe, t_ejecucion, t_tab_auditoria = st.tabs(
      [label_msg, "Ejecución", "📍 TABLERO DE AUDITORÍA"]
  )
  ...
  with t_ejecucion:
    ...
    with col_g1:
      ...
      g_alta_asig = st.selectbox(
          "Asignar a:", LISTA_SUPS_TACTICOS, key="jefe_alta_asig"
      )
  ...
  with t_tab_auditoria:
    st.markdown(
        f"### ⏱️ AUDITORÍA DE TIEMPOS, OBJETIVOS Y FLOTA POR SUPERVISOR"
    )
    ...
    if not df_qr_aud.empty:
      df_qr_aud.columns = [
          str(c).strip().upper() for c in df_qr_aud.columns
      ]
      col_sup_q = (
          "SUPERVISOR"
          if "SUPERVISOR" in df_qr_aud.columns
          else df_qr_aud.columns[3]
      )
      if col_sup_q in df_qr_aud.columns:
        for s in (
          ...
          if s and s != "NAN":
            supervisores_en_qr_set.add(s)

    if not df_jornada_aud.empty:
      df_jornada_aud.columns = [
          str(c).strip().upper() for c in df_jornada_aud.columns
      ]
      col_sup_j = (
          "SUPERVISOR"
          if "SUPERVISOR" in df_jornada_aud.columns
          else df_jornada_aud.columns[1]
      )
      if col_sup_j in df_jornada_aud.columns:
        for s in (
            df_jornada_aud[col_sup_j]
            .dropna()
            .astype(str)
            .str.strip()
            .str.upper()
    ...
    if not df_flota_aud.empty:
      df_flota_aud.columns = [
          str(c).strip().upper() for c in df_flota_aud.columns
      ]
      col_sup_f = (
          "SUPERVISOR"
          if "SUPERVISOR" in df_flota_aud.columns
          else df_flota_aud.columns[1]
      )
      if col_sup_f in df_flota_aud.columns:
        for s in (
            df_flota_aud[col_sup_f]
            .dropna()
            .astype(str)
            .str.strip()
            .str.upper()
    ...
    if len(supervisores_en_qr) > 0:
      ...
      for idx_pj, sup_seleccionado_jefe in enumerate(supervisores_en_qr):
        with pestanas_jefe[idx_pj]:
          st.markdown(
              f"### 🛡️ REPORTE TÁCTICO INTEGRAL:"
              f" **{sup_seleccionado_jefe}**"
          )
          ...
          if not df_jornada_aud.empty:
            ...
            df_sup_jor = df_jornada_aud[
                df_jornada_aud[col_s_j].astype(str).str.strip().str.upper()
                == str(sup_seleccionado_jefe).strip().upper()
            ]
            if not df_sup_jor.empty:
              inicios_jor = df_sup_jor[
                  df_sup_jor[col_a_j].astype(str).str.strip().str.upper()
                  == "INICIO"
              ]
              fines_jor = df_sup_jor[
                  df_sup_jor[col_a_j].astype(str).str.strip().str.upper()
                  == "FIN"
              ]
              ...
              if dt_ini_j and dt_fin_j and dt_fin_j >= dt_ini_j:
                ...
                mi_j = m_tot_j % 60
                total_horas_trabajadas = (
                    f"{h_j}h {mi_j}m" if h_j > 0 else f"{mi_j} min"
                )
          ...
          df_sup_qrs = (
              df_qr_aud[
                  df_qr_aud[col_sup_q].astype(str).str.strip().str.upper()
                  == str(sup_seleccionado_jefe).strip().upper()
              ]
              if not df_qr_aud.empty and col_sup_q in df_qr_aud.columns
              else pd.DataFrame()
          )
          ...
          if not df_sup_qrs.empty:
            df_sup_qrs.columns = [
                str(c).strip().upper() for c in df_sup_qrs.columns
            ]
            ...
            objetivos_visitados_set = (
                df_sup_qrs[col_obj_qr]
                .dropna()
                .astype(str)
                .str.strip()
                .str.upper()
            ...
            for obj_v in objetivos_visitados_set:
              df_obj_reg = df_sup_qrs[
                  df_sup_qrs[col_obj_qr].astype(str).str.strip().str.upper()
                  == obj_v
              ]
              inicios_obj = df_obj_reg[
                  df_obj_reg[col_acc_qr].astype(str).str.strip().str.upper()
                  == "INICIO"
              ]
              fines_obj = df_obj_reg[
                  df_obj_reg[col_acc_qr].astype(str).str.strip().str.upper()
                  == "FIN"
              ]
              ...
              if not inicios_obj.empty:
                ...
                try:
                  dt_ing = datetime.strptime(ingreso_str, "%H:%M:%S")
                except:
                  pass
              ...
              if not fines_obj.empty:
                ...
                try:
                  dt_egr = datetime.strptime(egreso_str, "%H:%M:%S")
                except:
                  pass
            ...
            st.markdown(
                "##### 📍 Detalle de Permanencia por Objetivo (Escaneos QR)"
            )
            st.dataframe(
                df_tabla_permanencia, use_container_width=True, hide_index=True
            )
          else:
          ...
          if not df_nov_aud.empty and len(objs_del_sup) > 0:
            df_nov_aud.columns = [
                str(c).strip().upper() for c in df_nov_aud.columns
            ]
            df_nov_aud["OBJETIVO_CLEAN"] = (
                df_nov_aud["OBJETIVO"].astype(str).str.strip().str.upper()
                if "OBJETIVO" in df_nov_aud.columns
                else ""
            )
            col_ev = next(
                (
                    p
                    for p in ["TIPO_EVENTO", "TIPO EVENTO", "EVENTO", "TIPO"]
                    if p in df_nov_aud.columns
                ),
                df_nov_aud.columns[2] if len(df_nov_aud.columns) > 2 else None,
            )
            if col_ev:
              mask_f = df_nov_aud["OBJETIVO_CLEAN"].isin(
                  objs_del_sup
              ) & df_nov_aud[col_ev].astype(str).str.upper().str.contains(
                  "MARCACIÓN|FICHAJE|INGRESO|EGRESO", regex=True
              )
              ...
              if not df_fich_raw.empty:
                ...
                for _, r in df_fich_raw.iterrows():
                  ...
                  ingreso_col = (
                      nombre_vig
                      if "INGRESO" in ev_val.upper()
                      or "MARCACIÓN_INGRESO" in ev_val.upper()
                      else "---"
                  )
                  egreso_col = (
                      nombre_vig
                      if "EGRESO" in ev_val.upper()
                      or "MARCACIÓN_EGRESO" in ev_val.upper()
                      else "---"
                  )
          ...
          if not df_vig_rel_aud.empty and len(objs_del_sup) > 0:
            df_vig_rel_aud.columns = [
                str(c).strip().upper() for c in df_vig_rel_aud.columns
            ]
            col_ov = (
                "OBJETIVO"
                if "OBJETIVO" in df_vig_rel_aud.columns
                else df_vig_rel_aud.columns[2]
            )
            df_rel_filtrado = df_vig_rel_aud[
                df_vig_rel_aud[col_ov]
                .astype(str)
                .str.strip()
                .str.upper()
                .isin([o.upper() for o in objs_del_sup])
          ...
          if not df_alertas_aud.empty and "TIPO" in df_alertas_aud.columns:
            df_pan_op = df_alertas_aud[
                df_alertas_aud["TIPO"].astype(str).str.strip().str.upper()
                == "PÁNICO"
            ]
            mask_s_pan = (
                df_pan_op["USUARIO"].astype(str).str.strip().str.upper()
                == sup_seleccionado_jefe
            )
          ...
          if not df_alertas_aud.empty and "TIPO" in df_alertas_aud.columns:
            ...
            mask_v_pan = df_pan_op["OBJETIVO"].astype(str).str.strip().str.upper().isin(
                [o.upper() for o in objs_del_sup]
            )
            mask_no_sup = ~(
                df_pan_op["USUARIO"].astype(str).str.strip().str.upper()
                == sup_seleccionado_jefe
          ...
          if not df_alertas_aud.empty:
            df_alertas_aud.columns = [
                str(c).strip().upper() for c in df_alertas_aud.columns
            ]
            df_alt_op = (
                df_alertas_aud[
                    df_alertas_aud["TIPO"].astype(str).str.strip().str.upper()
            ...
            mask_alt = (
                ...
                df_alt_op["SUPERVISOR"].astype(str).str.strip().str.upper()
                == sup_seleccionado_jefe
          ...
          if not df_flota_aud.empty:
            ...
            col_sf = (
                ...
                if "SUPERVISOR" in df_flota_aud.columns
                    ...
                    df_flota_aud.columns[1]
                    if len(df_flota_aud.columns) > 1
                    else None
                )
            )
            if col_sf:
              df_flota_sup_filtro = df_flota_aud[
                  df_flota_aud[col_sf].astype(str).str.strip().str.upper()
                  == str(sup_seleccionado_jefe).strip().upper()
              ].copy()
          ...
          with st.expander(
              f"👁️ VISTA PREVIA DEL REPORTE TÁCTICO: {sup_seleccionado_jefe}",
              expanded=True,
          ):
            st.markdown(
                f"**Supervisor:** {sup_seleccionado_jefe} | **Emisión:**"
                f" {obtener_hora_argentina()}"
            )
            ...
            st.dataframe(
                df_resumen_jor_prev, use_container_width=True, hide_index=True
            )

            st.markdown(
                "##### 📍 Detalle de Escaneos QR y Permanencia"
            )
            if not df_tabla_permanencia.empty:
              st.dataframe(
                  df_tabla_permanencia,
                  use_container_width=True,
                  hide_index=True,
              )
            else:
            ...
            if not df_fich_filtrado.empty:
              st.dataframe(
                  df_fich_filtrado, use_container_width=True, hide_index=True
              )
            else:
            ...
            if not df_rel_filtrado.empty:
              st.dataframe(
                  df_rel_filtrado, use_container_width=True, hide_index=True
              )
            else:
            ...
            total_alertas_supervisor_j = (
                len(df_pan_sup_filtrado)
                if not df_pan_sup_filtrado.empty
                else 0
            )
            total_alertas_vigilador_j = (
                len(df_pan_vig_filtrado)
                if not df_pan_vig_filtrado.empty
                else 0
            )

            if (
                total_alertas_supervisor_j > 0
                or total_alertas_vigilador_j > 0
                or not df_alt_sup_filtrado.empty
            ):
              st.markdown("##### ⚠️ Alertas Operativas")
              if total_alertas_supervisor_j > 0:
                st.markdown(
                    f"• TOTAL ALERTAS DE SUPERVISOR:"
                    f" **{total_alertas_supervisor_j}**"
                )
              if total_alertas_vigilador_j > 0:
                st.markdown(
                    f"• TOTAL ALERTAS DE VIGILADOR:"
                    f" **{total_alertas_vigilador_j}**"
                )
              if not df_alt_sup_filtrado.empty:
                st.dataframe(
                    df_alt_sup_filtrado,
          ...
          def generar_pdf_integral_completo(
              sup_nombre,
              j_ini,
              j_fin,
              j_tot,
            ...
            elementos.append(
                Paragraph(
                    "<b>AION-YAROKU | REPORTE TÁCTICO INTEGRAL DE"
                    " SUPERVISOR</b>",
                    estilo_titulo,
                )
            )
            elementos.append(
                Paragraph(
                    f"<b>Supervisor: {sup_nombre}</b> | Emisión:"
                    f" {obtener_hora_argentina()}",
                    estilo_sub,
                )
            )
            ...
            elementos.append(
                Paragraph(
                    "<b>Control de Jornada y Horas Trabajadas:</b>",
                    estilo_seccion,
                )
            )
            ...
            def agregar_tabla_pdf(titulo_sec, df_in, anchos_personalizados=None):
              elementos.append(
                  Paragraph(f"<b>{titulo_sec}</b>", estilo_seccion)
              )
              if not df_in.empty:
                ...
                if (
                    ...
                    and len(anchos_personalizados) == num_cols
                ):
                ...
                datos = []
                fila_encabezados = [
                    Paragraph(str(c), estilo_cab) for c in cols
                ]
                ...
                elementos.append(
                    Paragraph("Sin registros en este periodo.", estilo_texto)
                )
              elementos.append(Spacer(1, 6))

            agregar_tabla_pdf(
                "Detalle de Escaneos QR y Permanencia por Objetivo:",
                d_perm,
                [180, 180, 180, 204],
            )
            agregar_tabla_pdf(
                "Fichaje de Vigiladores:",
                d_fich,
                [80, 110, 100, 90, 90, 90, 184],
            )
            agregar_tabla_pdf(
                "Relevos de Vigiladores:",
                d_rel,
                [60, 100, 120, 120, 70, 90, 184],
            )
            ...
            if tot_s_cnt > 0 or tot_v_cnt > 0 or not d_alt.empty:
              elementos.append(
                  Paragraph("<b>Alertas Operativas</b>", estilo_seccion)
              )
              if tot_s_cnt > 0:
                elementos.append(
                    Paragraph(
                        f"• TOTAL ALERTAS DE SUPERVISOR: <b>{tot_s_cnt}</b>",
                        estilo_texto,
                    )
                )
              if tot_v_cnt > 0:
                element_v = Paragraph(
                    f"• TOTAL ALERTAS DE VIGILADOR: <b>{tot_v_cnt}</b>",
                    estilo_texto,
                )
              ...
              if not d_alt.empty:
                agregar_tabla_pdf(
                    "Detalle de Alertas Operativas:", d_alt
                )

            agregar_tabla_pdf(
                "Control de Flota:",
                d_flota,
                [75, 70, 70, 60, 100, 90, 90, 189],
            )
          ...
          st.download_button(
              label=(
                  "📥 DESCARGAR REPORTE TÁCTICO INTEGRAL (PDF COMPLETO) -"
                  f" {sup_seleccionado_jefe}"
              ),
              data=pdf_bytes_integral,
              file_name=(
                  "reporte_tactico_integral_"
                  f"{sup_seleccionado_jefe.replace(' ', '_')}.pdf"
              ),
      ...
      st.info(
          "No hay registros activos de supervisores en el sistema todavía."
      )
    ...
    if st.session_state.rol_sel == "GERENCIA":
      ...
      st.info(
          "ℹ️ Esta acción archivará y limpiará las tablas operativas actuales"
          " para iniciar un nuevo ciclo."
      )
      if st.button("EJECUTAR CIERRE TÁCTICO MENSUAL"):
        if ejecutar_cierre_táctico():
          st.success(
              "✅ ¡Cierre táctico ejecutado con éxito! Ciclo reiniciado."
          )
          st.rerun()
...
# =========================================================================
  ...
  if st.session_state.admin_autenticado:
    st.markdown('<div class="panel-novedad">', unsafe_allow_html=True)
    st.markdown(
        "### ⚙️ NÚCLEO MAESTRO: PANEL DE CONTROL DE ADMINISTRACIÓN"
    )
    ...
    df_pan_vig_adm = (
        ...
        if not df_alt_m.empty and "TIPO" in df_alt_m.columns
        else pd.DataFrame()
    )
    ...
    t_adm_usr, t_adm_obj, t_adm_mantenimiento = st.tabs([
        ...
        "🛡️ RESPALDO Y ARCHIVO TÁCTICO",
    ])

    with t_adm_usr:
      st.markdown(
          "#### 👤 SOLICITUDES DE ACCESO Y PADRÓN DE USUARIOS"
      )
      if not df_usr_m.empty:
        st.dataframe(
            df_usr_m[["USUARIO", "ROL", "ESTADO"]],
            use_container_width=True,
            hide_index=True,
        )
        pdf_usuarios = generar_pdf_reporte(
            "PADRÓN GENERAL DE USUARIOS Y ACCESOS",
            df_usr_m[["USUARIO", "ROL", "ESTADO"]],
        )
        st.download_button(
            "📥 DESCARGAR PADRÓN DE USUARIOS (PDF)",
            data=pdf_usuarios,
            file_name=(
                "padron_usuarios_"
        ...
        if "ESTADO" in df_usr_m.columns:
          ...
          if not pendientes_u.empty:
            usuario_a_aprobar = st.selectbox(
                "Seleccionar usuario para autorizar:",
                pendientes_u["USUARIO"].tolist(),
                key="sel_usr_aprobar",
            )
            if st.button("✅ DAR ACCESO Y APROBAR USUARIO", use_container_width=True):
              idx = df_usr_m[df_usr_m["USUARIO"] == usuario_a_aprobar].index[
                  0
              ]
              if actualizar_celda("USUARIOS", idx + 2, "D", "APROBADO"):
                st.success(
                    f"✅ ¡Usuario {usuario_a_aprobar} autorizado correctamente!"
                )
                st.cache_data.clear()
                st.rerun()
    ...
    with t_adm_obj:
      st.markdown(
          "#### 📋 LISTADO GENERAL DE OBJETIVOS EN LA RED"
      )
      if not df_obj_m.empty:
        st.dataframe(
            df_obj_m[["OBJETIVO", "DIRECCION", "LOCALIDAD", "SUPERVISOR"]],
            use_container_width=True,
            hide_index=True,
        )
        pdf_objetivos = generar_pdf_reporte(
            "PADRÓN GENERAL DE OBJETIVOS ACTIVOS",
            df_obj_m[["OBJETIVO", "DIRECCION", "LOCALIDAD", "SUPERVISOR"]],
        )
        st.download_button(
            "📥 DESCARGAR PADRÓN DE OBJETIVOS (PDF)",
            data=pdf_objetivos,
            file_name=(
                "padron_objetivos_"
                f"{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf"
    ...
    with t_adm_mantenimiento:
      ...
      if not df_obj_m.empty:
        pdf_respaldo_objs = generar_pdf_reporte(
            "RESPALDO GENERAL DE OBJETIVOS ACTIVOS",
            df_obj_m[["OBJETIVO", "DIRECCION", "LOCALIDAD", "SUPERVISOR"]],
        )
        st.download_button(
            "📥 DESCARGAR RESPALDO DE OBJETIVOS (PDF)",
