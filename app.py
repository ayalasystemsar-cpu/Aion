...
def aplicar_identidad_alfa():
    st.markdown(
        ...
        .logo-sidebar { width: 150px !important; filter: drop-shadow(0 0 10px rgba(0, 229, 255, 0.5)); }
...
# --- 5. SIDEBAR (LOGO + PANEL DE CONTROL) ---
with st.sidebar:
...
# --- C. RESTO DE ROLES (ADMIN, GERENCIA, JEFE OPS) ---
