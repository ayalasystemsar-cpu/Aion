...
if not st.session_state.usuario_logueado:
    mostrar_landing() # Esta es tu pantalla de login (La que sí quieres)
else:
    # TODO LO QUE NO QUIERES QUE SE VEA AL PRINCIPIO VA AQUÍ ADENTRO:
    # 1. Carga de datos
    df_objetivos = cargar_objetivos()
    df_comisarias = cargar_datos_comisarias()
    
    # 2. Cálculos del mapa (donde estaba tu error)
    df_mapa_monitoreo = ... # (Asegúrate de que esto esté dentro del else)
    
    # 3. Dibujo de componentes operativos
    # ...
